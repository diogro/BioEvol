...
```{r}
cov_matrix_BD = (60 * cov_matrices$D + 60 * cov_matrices$B)/120
cov_matrix_BD
```
...
O resultado é o mesmo. Você pode ler o termo `as.matrix(dentus_BD[,1:4])~dentus_BD[,5]` como: _as colunas de 1 a 4 do objeto dentus_BD em função da quinta coluna do objeto dentus_BD_. Você pode pensar no operado `~` como um "_em função de_". Variáveis dependentes à esquerda e preditoras à direita.
